...
the \code{"longtable"} environment to allow this to cross page boundaries.  The \code{toprule}
setting inserts the caption, which the \code{longtable} package requires to be \textit{within}
the table; the
...
default style, use \verb!\\hline! in place of \verb!\\toprule! and \verb!\\midrule! in the
settings instead.  
